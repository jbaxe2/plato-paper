...
class UserInformation {
  /**
   * The username and password for the user; could be empty [String]s for new users.
   */
  ...
  /**
   * The [toJson] method outputs a JSON-based [String] representation of the user
   * information reflected by this class.
   */
  String toJson() {
    Map userJson = new Map()
      ..['username'] = _username
      ..['password'] = _password
